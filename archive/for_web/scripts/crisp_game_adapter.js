/**
 * Crisp Game Library Adapter for game-testing-framework.js
 *
...
function createCrispGameAdapter(gamePath) {
  ...
  const crispGlobals = {
    ...
    color: function(colorName) {
      ...
      if (globalScope.simulator && typeof globalScope.simulator.color === 'function') {
    ...
    rect: function(...args) {
      if (globalScope.simulator && typeof globalScope.simulator.rect === 'function') {
    ...
    box: function(...args) {
      if (globalScope.simulator && typeof globalScope.simulator.box === 'function') {
    ...
    text: function(...args) {
      if (globalScope.simulator && typeof globalScope.simulator.text === 'function') {
    ...
    char: function(...args) {
      if (globalScope.simulator && typeof globalScope.simulator.char === 'function') {
    ...
    line: function(...args) {
      if (globalScope.simulator && typeof globalScope.simulator.line === 'function') {
    ...
    bar: function(...args) {
      if (globalScope.simulator && typeof globalScope.simulator.bar === 'function') {
    ...
    arc: function(...args) {
      if (globalScope.simulator && typeof globalScope.simulator.arc === 'function') {
    ...
    rnd: function(min, max) {
      ...
      if (min === undefined && max === undefined) {
        if (globalScope.simulator && typeof globalScope.simulator.random === 'function') {
      ...
      if (globalScope.simulator && typeof globalScope.simulator.randomRange === 'function') {
    ...
    rndi: function(min, max) {
      ...
      if (globalScope.simulator && typeof globalScope.simulator.randomInt === 'function') {
    ...
    loadCharacters: function(characters) {
      if (globalScope.simulator && typeof globalScope.simulator.loadCharacters === 'function') {
  ...
  Object.keys(globalScope).forEach(key => {
    ...
    if (!(key in originalGlobals) && !(key in crispGlobals) &&
        key !== 'title' && key !== 'description' && key !== 'characters' &&
    ...
    update: function(input, simulator) {
      ...
      if (typeof gameModule.update === 'function') {
        try {
          ...
          console.error(`[ERROR] Game update failed at tick ${gameState.ticks}:`, err.message);
